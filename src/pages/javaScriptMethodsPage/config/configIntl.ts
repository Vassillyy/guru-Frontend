  ...
  [Methods.INTL]: [
    {
      ...
      description:
        'Конструктор объектов для форматирования дат и времени с учётом locales.\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для форматирования чисел с учётом locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для определения множественной формы числа в соответствии с правилами locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для сравнения строк с учётом правил locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для получения названий языков, регионов, скриптов, валют и других элементов с учётом locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для форматирования списков с учётом locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для форматирования относительного времени с учётом locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для сегментации текста на графемы, слова или предложения с учётом правил locales.\n' +
        'Созданный объект предоставляет следующие методы:\n' +
    ...
    },
    {
      ...
      description:
        'Конструктор объектов для работы с языковыми тегами. Предоставляет информацию о locales и методы для её модификации.\n' +
    ...
    },
    {
      ...
      description:
        'Статический метод, возвращающий массив канонических кодов locales.\n' +
    ...
    },
    {
      ...
      description:
        'Статический метод, возвращающий массив поддерживаемых значений для key с учётом locales.\n' +
