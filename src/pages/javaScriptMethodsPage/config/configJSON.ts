  ...
  [Methods.JSON]: [
    {
      ...
      description:
        ...
        'Если объект содержит циклические ссылки, будет выброшена ошибка. Если объект имеет метод toJSON(), он будет вызван, и его возвращаемое значение будет сериализовано вместо исходного объекта.',
      example:
    ...
    },
    {
      ...
      description:
        ...
        'Объекты Function, RegExp и Error не могут быть преобразованы обратно в объект.',
      example:
