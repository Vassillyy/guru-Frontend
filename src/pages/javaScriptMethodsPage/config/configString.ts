...
export const configString: Record<Methods.STRING, IMethod[]> = {
  [Methods.STRING]: [
      ...
      parameters: [
        {
          name: 'index',
          description:
            'Индекс символа (если передадим отрицательное значение - вернет пустую строку)',
        },
      ],
      description:
    ...
    },
    {
      ...
      description:
        'Метод объекта String, выполняет поиск подстроки в исходной строке с конца. Метод возвращает индекс перого (с конца) совпадения или -1, если подстрока не найдена.',
      example:
    ...
    },
    {
      ...
      description:
        'Метод объекта String, проверяет, содержит ли исходная строка указанную подстроку. Возвращает true если содержит, иначе false.',
      example:
    ...
    },
    {
      ...
      description:
        ...
        '• С двумя аргументами: символы от индекса, указанного в первом аргументе, до индекса, указанного во втором аргументе;\n' +
        '• С одним аргументом: символы от индекса, указанного в аргументе, до конца строки;\n' +
    ...
    },
    {
      ...
      description:
        'Метод объекта String, разбивает строку на массив по указанному разделителю. Второй аргумент отвечает за ограничение количества элементов в массиве, если их больше чем указано, то остаток будет отброшен.',
      example:
