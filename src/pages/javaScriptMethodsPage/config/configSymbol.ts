...
export const configSymbol: Record<Methods.SYMBOL, IMethod[]> = {
  [Methods.SYMBOL]: [
    ...
    {
      name: 'Symbol.match',
      syntax: 'obj[Symbol.match](str)',
      parameters: [
        {
          name: 'str',
          description: 'Строка, в которой выполняется поиск совпадения',
        },
      ],
      description:
    ...
    },
    {
      ...
      syntax: 'obj[Symbol.matchAll](str)',
      parameters: [
        {
          name: 'str',
          description: 'Строка, в которой выполняется поиск всех совпадений',
        },
      ],
      description:
