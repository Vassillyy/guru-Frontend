    ...
    sections: [
      {
        ...
        addition:
          ...
          '• CSS-позиционированный предок (position: absolute, relative, fixed, sticky)\n' +
          '• <td>, <th>, <table>\n' +
          '• <body>\n' +
      ...
      },
      {
        ...
        addition:
          'offsetWidth = CSS-ширина + padding-left + padding-right + border-left + border-right\n' +
          'offsetHeight = CSS-высота + padding-top + padding-bottom + border-top + border-bottom\n\n' +
        ...
        examples:
          ...
          '      // Расчёт: 300 (ширина) + 40 (padding: 20+20) + 50 (border: 25+25) = 390\n' +
          '      console.log("offsetWidth:", elem.offsetWidth);  // 390\n' +
          '      console.log("offsetHeight:", elem.offsetHeight); // 290\n\n' +
          '      // Для скрытого элемента\n' +
          '      let hidden = document.getElementById("hidden");\n' +
          '      console.log("Скрытый offsetWidth:", hidden.offsetWidth); // 0\n' +
          '      console.log("Скрытый offsetHeight:", hidden.offsetHeight); // 0\n' +
          '    </script>\n' +
          '  </body>\n' +
          '</html>',
      },
      ...
      },
      {
        ...
        addition:
          'clientWidth = padding-left + padding-right + width - scrollbar-width\n' +
          'clientHeight = padding-top + padding-bottom + height - scrollbar-height',
        examples:
          '<html>\n' +
          '  <body>\n' +
          ...
          '    </div>\n\n' +
          '    <!-- Элемент, без прокрутки для сравнения -->\n' +
      ...
      },
      {
        ...
        addition:
          'scrollWidth = общая ширина контента + padding (если ширина контента больше clientWidth)\n' +
          'scrollHeight = общая высота контента + padding (если высота контента больше clientHeight)',
        examples:
          '<html>\n' +
          '  <body>\n' +
      ...
      },
      {
        ...
        addition:
          ...
          'Если браузер не выделяет место под полосу прокрутки, значение может быть 0px.',
        examples:
          '<html>\n' +
          '  <body>\n' +
          '    <script>\n' +
          ...
          '        console.log(scrollWidth); // 15 (ширина скролла)\n\n' +
          '        div.remove();\n' +
          '        return scrollWidth;\n' +
          '      }\n\n' +
          '      getScrollbarWidth();\n' +
