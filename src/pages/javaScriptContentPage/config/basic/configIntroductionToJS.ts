  ...
  content: {
    ...
    sections: [
      ...
      },
      {
        title: 'Встраиваемый:',
        content:
          'JavaScript не существует в изоляции — он всегда выполняется внутри host-среды (браузер, Node.js). Среда предоставляет различные API (DOM, fetch, http) для взаимодействия с внешним миром, которых нет в самом языке. Сам код исполняется движком JavaScript (V8, SpiderMonkey), встроенным в эту среду.',
        addition:
