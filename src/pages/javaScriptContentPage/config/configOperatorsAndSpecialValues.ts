...
export const configOperatorsAndSpecialValues: ITopic = {
  ...
  name: 'Операторы, специальные значения и escape-последовательности',
  content: {
    introduction:
    ...
    sections: [
      ...
      },
      {
        ...
        addition:
          ...
          'Различия || и ?? в том, что или возвращает первое истинное значение, а ?? первое определенное значение.',
        examples:
      ...
      },
      {
        ...
        content: 'typeof — возвращает тип значения',
        addition:
          "Возвращает строку с типом аргумента. Возможные значения: 'undefined', 'boolean', 'number', 'string', 'bigint', 'symbol', 'object', 'function'. Для null возвращает 'object' (историческая особенность). Оператор имеет две синтаксические формы: typeof x и typeof(x).",
        examples:
      ...
      {
        title: 'Оператор new',
        content: 'new — создает экземпляр конструктора',
        addition:
      ...
      {
        title: 'Специальные символы (escape-последовательности)',
        content:
          'В строковых литералах JavaScript поддерживаются специальные символы, которые начинаются с обратного слеша \\.',
        addition:
          'Специальные символы используются для вставки в строку символов, которые сложно или невозможно ввести напрямую: перевод строки, кавычки, табуляция и т.д.\n' +
        ...
        examples:
          ...
          '// Backspace\n' +
          'console.log("ABC\\bD"); // ABD (символ C удалён)',
      },
    ],
  },
};
